...
using ParkHyderabadOperator.DAL.DALVehicleType;
...
namespace ParkHyderabadOperator
{
	...
	public partial class LotViolationTestPage : ContentPage
	{
        ...
        public void LoadLotVehicleType()
        {
            try
            {
                if (App.Current.Properties.ContainsKey("LoginUser") && App.Current.Properties.ContainsKey("apitoken"))
                {
                    DALVehicleType dal_VehicleType = new DALVehicleType();
                    User objloginuser = (User)App.Current.Properties["LoginUser"];
                    List<VehicleType> lstlotVehicles = dal_VehicleType.GetLocationLotActiveVehicleTypes(Convert.ToString(App.Current.Properties["apitoken"]), objloginuser);
                    lstLotActiveVehicleType.ItemsSource = lstlotVehicles;
